...
| Решение пользователя | «Щит» → «Защита сертификатов»: выбор доменов галочками, массовые исключения на сеанс/час/постоянно; приватные разрешения хранятся в памяти |
