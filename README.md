...
* [**CAnttRUst**](https://github.com/ISAIandCO/CAnttRUst) — похожая модель контроля Russian Trusted Root CA в виде расширения Firefox;
* [Ruthenium for Android](https://github.com/rutheniumteam/ruthenium-android) — Chromium-проект, послуживший одним из референсов идеи ограниченного доверия.
