...
> Нативная интеграция CAnttRUst в этой ветке проходит проверку. Это описание
...
| Решение пользователя | «Щит» → «Защита сертификатов»: постоянные исключения для точных имён, в том числе несколько сразу; приватные разрешения хранятся в памяти |
